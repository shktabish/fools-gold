export default function Telegram() {
  return (
    <div className="min-h-[85dvh] bg-[#E03938] p-2 md:p-4 lg:p-6 rounded-xl grid grid-cols-1 md:grid-cols-2 md:grid-rows-[30%_60%] place-content-between md:gap-6 gap-2">
      ...
      <div className="h-full bg-white md:rounded-xl rounded-lg lg:p-8 lg:py-14 space-y-4 flex flex-col md:items-start items-center justify-center relative overflow-hidden p-4">
        <img
          src="./bg-effect.png"
          alt="bg-effect image"
        ...
        <p className="font-helvetica font-bold italic text-[#D73939] text-sm md:text-lg lg:text-2xl text-center md:text-start z-20 relative">
          This meme ecosystem is a complete world that captures the essence of
          cheeky charm and good old-fashioned savvy. Like Del Boy and
          Rodney&apos;s outrageous schemes, our coin is about seizing
          opportunities to generate Cushty ATHs!
        </p>
        ...
        <p className="font-helvetica uppercase text-[#D73939] text-xs md:text-sm lg:text-md text-center md:text-start font-bold tracking-tighter z-20 relative">
          Not your normal meme this is the real deal coded by industry experts.
          A genuine token built for the community. No inside shady shenanigans.
        </p>
      </div>
      <div className="relative h-[250px] md:h-full bg-white md:rounded-2xl rounded-lg overflow-hidden">
        <img
