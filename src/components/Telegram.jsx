export default function Telegram() {
	return (
		<div className="min-h-[80dvh] bg-[#E03938] p-2 md:p-4 lg:p-6 rounded-xl grid grid-cols-1 md:grid-cols-2 md:grid-rows-[35%_60%] place-content-between gap-4">
			<div className="md:col-span-2 bg-[#FFD677] grid grid-cols-1 md:grid-cols-[50%_10%_40%] xl:grid-cols-[60%_10%_30%] p-4 lg:p-6 rounded-lg md:rounded-xl h-fit relative bg-[url(./fullstar.png)] bg-no-repeat bg-contain bg-left ">
